...
import static com.example.finalproject.UserActivity.CartFragment.total;
import static com.example.finalproject.UserActivity.CartFragment.tvTotal;
...
public class FoodListInCartAdapter extends ArrayAdapter<Food> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        btnDeleteFromCart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        new AlertDialog.Builder(getContext())
                ...
                .setPositiveButton("Có", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        DatabaseReference listFoodsRef = database.getReference("list_users/"+user.getUid()+"/carts");
